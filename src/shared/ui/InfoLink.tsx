export default function InfoLink() {
  return (
    <a
      ...
      className="inline-flex justify-between items-center py-1 px-1 pe-4 mb-7 text-sm text-blue-700 bg-blue-100 rounded-full  select-none animate-fade-in animate-delay-500 hover:bg-blue-700 hover:text-blue-100 transition-colors"
    >
